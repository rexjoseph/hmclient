...
const EditBanner = () => {
  ...
  const banner = useSelector((state) => state.banner.banners.find((banner) => banner._id === bannerId))
            ...
            <div className="flex">
              ...
              <div className="mainbody">
                <div className="mainbody-header">
                  ...
                  <div className="span">
                    <span>
                      The most important feature in the product addition
                      section. When adding products here, do not ignore to fill
                      in all the required fields completely and follow add
                      follow the product adding rules.
                    </span>
                  </div>
                </div>
